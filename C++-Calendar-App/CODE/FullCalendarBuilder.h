...
public:
	...
	virtual std::shared_ptr<DisplayableComponent> buildEventDecorator(std::shared_ptr<DisplayableComponent> cal,std::string calName, std::string eventName, std::tm when, int recurrEvery, int recurrFor);
protected:
	...
	std::shared_ptr<DisplayableComponent> getMonth(std::shared_ptr<DisplayableComponent> year, tm d);
	std::shared_ptr<DisplayableComponent> getDay(std::shared_ptr<DisplayableComponent> month, tm d);
