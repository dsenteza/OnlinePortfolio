...
public:
	...
	virtual std::shared_ptr<DisplayableComponent> buildEventDecorator(std::shared_ptr<DisplayableComponent> cal, std::string calName, std::string eventName, std::tm when, int recurrEvery, int recurrFor) = 0;
